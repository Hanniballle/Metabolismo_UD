...
const FeedGames = () => {
  const games = [
    ...
    { id: 3, title: 'Dobles: animales', image: '/juegos/j2.png', url: 'https://view.genially.com/682633329aa498be28762ac2/interactive-content-dobles-animales', kingdom: 'Reino 3' },
    { id: 4, title: 'Juego 4', image: '/path/to/image4.jpg', url: 'https://example.com/game4', kingdom: 'Animalia' },
