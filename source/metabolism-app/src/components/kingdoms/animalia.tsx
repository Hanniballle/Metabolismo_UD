...
const Animalia: React.FC<AnimaliaProps> = ({ onBack }) => {
  return (
    <Box sx={{ maxWidth: 900, mx: 'auto', pt: 4 }}>
      ...
      <HeaderKingdom 
        title={animaliaData.title}
        dirImage={animaliaData.dirImage}
        subtitle={animaliaData.subtitle}
        concept={animaliaData.concept}
        procedure={animaliaData.procedure}
        attitude={animaliaData.attitude}
      />
