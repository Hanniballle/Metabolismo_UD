...
const Animalia: React.FC<ChromistaProps> = ({ onBack }) => {
  ...
  const chromistaData = {
    ...
    dirImage: '/animalia/p2.jpg',
    subtitle: 'Tremarctos',
    concept: 'En este perfil encontraras las características principales del Reino Animalia y sus procesos metabólicos.',
    ...
    attitude: 'En el apartado de juegos encontrarás actividades relacionadas con el Reino Animalia, y al final de este perfil, la actividad final.',
  };
      ...
      {posts.map((post, i) => (
       ...
       <Typography variant="body1" sx={{ mt: 2 }}>
         Recuerda entrar al siguiente enlace:{' '}
          <Link
            href="https://es.educaplay.com/recursos-educativos/23838399-que_aprendiste_de_este_juego.html"
            target="_blank"
            rel="noopener"
              >
            ¿Qué aprendiste del Reino Animalia?
              </Link>
          </Typography>
