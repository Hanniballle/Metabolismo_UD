...
const Archaea: React.FC<ChromistaProps> = ({ onBack }) => {
  ...
  const chromistaData = {
    ...
    concept: 'En este perfil encontraras las características principales del Reino Archaea y sus procesos metabólicos.',
    ...
    attitude: 'En el apartado de juegos encontrarás actividades relacionadas con el Reino Archaea, y al final de este perfil, la actividad final.'
  };
      ...
      {posts.map((post, i) => (
        <Box key={i}>
         ...
         Recuerda entrar al siguiente enlace:{' '}
          <Link
            href="https://view.genially.com/68277b46236f2f2ed7d3a053/interactive-content-archaea"
            target="_blank"
            rel="noopener"
              >
            ¿Qué aprendiste del Reino Archaea?
              </Link>
          </Typography>
