...
const Bacteria: React.FC<ChromistaProps> = ({ onBack }) => {
  ...
  const chromistaData = {
    ...
    concept: 'En este perfil encontraras las características principales del Reino Bacteria y sus procesos metabólicos.',
    ...
    attitude: 'En el apartado de juegos encontrarás actividades relacionadas con el Reino Bacteria, y al final de este perfil, la actividad final.'
  };
      ...
      {posts.map((post, i) => (
        <Box key={i}>
         ...
         Recuerda entrar al siguiente enlace:{' '}
          <Link
            href="https://view.genially.com/6826a85ffe83ffb3b1f9449e/interactive-content-bacterisate"
            target="_blank"
            rel="noopener"
              >
            ¿Qué aprendiste del Reino Bacteria?
              </Link>
          </Typography>
